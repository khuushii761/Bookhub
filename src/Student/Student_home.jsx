    ...
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <aside className="w-64 bg-white shadow-md fixed h-full z-40">
        ...
        <nav className="p-6 space-y-4">
          ...
          <Link to="/borrowed" className="block text-gray-700 hover:text-indigo-700">Issue Book Request</Link>
          <Link to="/" className="block text-gray-700 hover:text-indigo-700"> Book Return</Link>
